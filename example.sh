...
#for testing
python main.py --testing="/content/drive/My Drive/logs/segnet_logs/model.ckpt-19999"  --log_dir="/content/drive/My Drive/logs/segnet_logs" --test_dir="nopeVal.txt" --batch_size=5 --save_image=True
