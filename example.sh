...
#for testing
python main.py --testing="/content/drive/My Drive/logs/segnet_logs/model.ckpt-19999"  --log_dir="/content/drive/My Drive/logs/segnet_logs" --test_dir="simulasyon.txt" --batch_size=1 --save_image=True
